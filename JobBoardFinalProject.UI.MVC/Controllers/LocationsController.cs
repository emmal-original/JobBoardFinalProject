...
namespace JobBoardFinalProject.UI.MVC.Controllers
{
    ...
    public class LocationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "LocationID,BranchNumber,StreetAddress,City,State,ZipCode,ManagerId")] Location location)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "LocationID,BranchNumber,StreetAddress,City,State,ZipCode,ManagerId")] Location location)
        {
            if (ModelState.IsValid)
            {
